...
```
Correlation test is performed to check the strength of relationship between severity and month.

```{r}
cor(clean_acc21$Severity, clean_acc21$Hour)
```
Correlation test is performed to check the strength of relationship between severity and hour.
