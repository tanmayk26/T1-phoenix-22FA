...
accidents_per_roadelement<-accidents_2021 %>% 
...
```{r}
accidents_per_roadelement[is.na(accidents_per_roadelement) | accidents_per_roadelement=="Inf"] = NA
```
...
ggplot(data=Junction_data, aes(x=Is_severe, y=Junction)) +
