...
For the rest of element, they have quite close mean and median and a few outliers.  
...
```
But we decided to keep the outliers because it is natural to have outliers in the weather  variables as it covers a whole year. Also the outliers does not affect the result of T-test.
