...
ggplot(df_spotify, aes(x = popularity, fill=popularity)) +
    geom_bar()+labs(title="Popularity Distribution ", x="Popularity", y = "count")+
...
ggplot(df_spotify, aes(x = danceability, fill=danceability)) +
    geom_bar()+labs(title="ADanceability Distribution", x="Danceability", y = "count")+
  theme(plot.title = element_text(hjust = 0.5))
```

```{r}
acHist <- ggplot(df_spotify, aes(x=acousticness)) + geom_histogram(fill="black", alpha=0.9, bins = 75)+
...
acV <- ggplot(df_spotify, aes(x=acousticness, y=popularity,fill=acousticness)) + 
  geom_violin() +
  ggtitle("Violin plot for Acousticness")
acV
```
...
speechinessHist <- ggplot(df_spotify, aes(x=speechiness)) + geom_histogram(fill="black", alpha=0.9, bins = 75)+
...
instrumentalnessHist <- ggplot(df_spotify, aes(x=instrumentalness)) + geom_histogram(fill="black", alpha=0.9, bins = 75)+
...
livenessHist <- ggplot(df_spotify, aes(x=liveness)) + geom_histogram(fill="black", alpha=0.9, bins = 75)+
...
valenceHist <- ggplot(df_spotify, aes(x=valence)) + geom_histogram(fill="black", alpha=0.9, bins = 75)+
  ggtitle("Histogram of instrumentalness")
valenceHist
...
tempoHist <- ggplot(df_spotify, aes(x=tempo)) + geom_histogram(fill="black", alpha=0.9, bins = 75)+
